...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "agents.defaults.scopeContext": "Scope Context",
  "agents.defaults.scopeContext.enabled": "Enable Scope Context",
  "agents.defaults.scopeContext.applyOn": "Scope Context Apply On",
  "agents.defaults.scopeContext.maxFileChars": "Scope Context Max File Chars",
  "agents.defaults.scopeContext.maxTotalChars": "Scope Context Max Total Chars",
